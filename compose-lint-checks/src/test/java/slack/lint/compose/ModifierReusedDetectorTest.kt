...
class ModifierReusedDetectorTest : BaseComposeLintTest() {
  ...
  fun `errors when the modifier parameter of a Composable is used more than once by siblings or parent-children`() {
    ...
    lint()
      ...
      .expect(
        """
        src/test.kt:6: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Row(modifier) {
                ~~~~~~~~
        src/test.kt:7: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier)
                                ~~~~~~~~
        src/test.kt:12: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Column(modifier = modifier) {
                              ~~~~~~~~
        src/test.kt:14: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = modifier)
                                           ~~~~~~~~
        src/test.kt:19: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Column(modifier = modifier) {
                              ~~~~~~~~
        src/test.kt:22: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            OtherComposable(modifier = modifier)
                                       ~~~~~~~~
        src/test.kt:23: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            OtherComposable(modifier = modifier.padding())
                                       ~~~~~~~~
        src/test.kt:28: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(myMod)
                                ~~~~~
        src/test.kt:29: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(myMod)
                                ~~~~~
        src/test.kt:35: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                modifier = modifier
                           ~~~~~~~~
        src/test.kt:40: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.
    ...
    lint()
      ...
      .expect(
        ...
        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Column(modifier = modifier) {
                              ~~~~~~~~
        src/test.kt:8: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = modifier.fillMaxWidth())
                                           ~~~~~~~~
        src/test.kt:13: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Column(modifier = modifier) {
                              ~~~~~~~~
        src/test.kt:15: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = newModifier)
                                           ~~~~~~~~~~~
        src/test.kt:21: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.
        ...
        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = newModifier)
                                           ~~~~~~~~~~~
        src/test.kt:27: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.
        ...
        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = Modifier.then(modifier))
                                                         ~~~~~~~~
        src/test.kt:33: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Column(modifier = modifier) {
                              ~~~~~~~~
        src/test.kt:34: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.
  ...
  fun `errors when multiple Composables use the modifier even when it's been assigned to a new val`() {
    ...
    lint()
      ...
      .expect(
        """
        src/test.kt:10: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.
        ...
        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = reassignedModifier)
                                           ~~~~~~~~~~~~~~~~~~
        src/test.kt:16: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            OtherComposable(modifier = tweakedModifier)
                                       ~~~~~~~~~~~~~~~
        src/test.kt:20: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
            Column(modifier = modifier) {
                              ~~~~~~~~
        src/test.kt:24: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.

        See https://slackhq.github.io/compose-lints/rules/#dont-re-use-modifiers for more information. [ComposeModifierReused]
                OtherComposable(modifier = tweakedModifier)
                                           ~~~~~~~~~~~~~~~
        src/test.kt:25: Error: The modifier is passed to more than one composable on this execution path. Pass it only to the top-level layout, and use Modifier for child composables.
